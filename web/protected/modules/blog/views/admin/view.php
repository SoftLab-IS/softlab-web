...
?>
	...
	<div class="row">
		<div class="large-6 columns panel">Autor Posta: <?php echo CHtml::link($autor->firstName . " ". $autor->lastName, 'index.radans.php?r=admincp/users/view&id='. $model->authorId); ?></div>
