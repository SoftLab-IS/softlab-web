...
class CategoriesController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('BlogCategories');
	 ...
	 * @param BlogCategories $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='blog-categories-form')
		{
